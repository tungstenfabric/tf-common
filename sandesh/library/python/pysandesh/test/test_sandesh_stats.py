...
class SandeshMessageStatisticsTest(unittest.TestCase):
    ...
    def _verify_tx_drop_stats(self, stats, tmsg, tbytes, nmsg, nbytes):
        ...
        self.assertEqual(
            nmsg, stats.messages_sent_dropped_session_not_connected)
        self.assertEqual(
            nbytes, stats.bytes_sent_dropped_session_not_connected)
        self.assertEqual(
            nmsg, stats.messages_sent_dropped_wrong_client_sm_state)
        self.assertEqual(
            nbytes, stats.bytes_sent_dropped_wrong_client_sm_state)
    ...
    def test_update_tx_stats(self):
        ...
        self.assertTrue(
            self.sandesh_msg_stats.update_tx_stats(
                'Message2', 192))
        ...
        # Message1
        msg_type_stats = self.sandesh_msg_stats.message_type_stats()[
            'Message1']
        ...
        self.assertFalse(self.sandesh_msg_stats.update_tx_stats(
            'Message1', 64, SandeshTxDropReason.MinDropReason))
        self.assertFalse(self.sandesh_msg_stats.update_tx_stats(
            'Message1', 64, SandeshTxDropReason.MinDropReason - 1))
        self.assertFalse(self.sandesh_msg_stats.update_tx_stats(
            'Message1', 64, SandeshTxDropReason.MaxDropReason))
        self.assertFalse(self.sandesh_msg_stats.update_tx_stats(
            'Message1', 64, SandeshTxDropReason.MaxDropReason + 1))
    ...
    def _verify_rx_drop_stats(self, stats, tmsg, tbytes, nmsg, nbytes):
        ...
        self.assertEqual(
            nmsg, stats.messages_received_dropped_control_msg_failed)
        self.assertEqual(
            nbytes, stats.bytes_received_dropped_control_msg_failed)
    ...
    def test_update_rx_stats(self):
        ...
        self.assertTrue(
            self.sandesh_msg_stats.update_rx_stats(
                'Message2', 192))
        ...
        self.assertFalse(self.sandesh_msg_stats.update_rx_stats(
            'Message1', 32, SandeshRxDropReason.MinDropReason))
        self.assertFalse(self.sandesh_msg_stats.update_rx_stats(
            'Message1', 64, SandeshRxDropReason.MinDropReason - 1))
        self.assertFalse(self.sandesh_msg_stats.update_rx_stats(
            'Message1', 96, SandeshRxDropReason.MaxDropReason))
        self.assertFalse(self.sandesh_msg_stats.update_rx_stats(
            'Message1', 64, SandeshRxDropReason.MaxDropReason + 1))
