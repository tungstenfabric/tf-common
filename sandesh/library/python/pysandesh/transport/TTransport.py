...
class CReadableTransport(object):
    ...
    def cstringio_refill(self, partialread, reqlen):
        ...
        Returns the currently used buffer (which can but need not be same as
        the old cstringio_buf). partialread is what C code has read from the
        buffer, and should be inserted into buffer before any more reads. The
