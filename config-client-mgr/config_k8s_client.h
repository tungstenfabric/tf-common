...
public:
    ...
    // Change route target name to make it K8s compliant
    static bool FixRouteTargetName(const Value& rt);
    ...
    Value K8sJsonCreateRef(const std::string& ref_name, const Value* ref_info, Document& cass_dom);
